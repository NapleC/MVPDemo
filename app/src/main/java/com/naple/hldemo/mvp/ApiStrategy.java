...
import com.naple.hldemo.utils.AppUtils;
import com.naple.hldemo.utils.NetWorkUtils;
...
public class ApiStrategy {
    ...
    private ApiStrategy() {
        ...
        //缓存
        File cacheFile = new File(AppUtils.INSTANCE.getCacheDir(), "cache");
    ...
    private final Interceptor mRewriteCacheControlInterceptor = new Interceptor() {
        ...
        public Response intercept(Chain chain) throws IOException {
            ...
            if (!NetWorkUtils.isNetConnected(AppUtils.INSTANCE)) {
